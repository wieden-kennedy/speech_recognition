...
class Recognizer(AudioSource):
    ...
    def listen_control(self, source, timeout = None, phrase_time_limit = None):
        """
        ...
        def endRecordingEventHandler():
            global isEndRecording
            while True:
        ...
        while True:
            ...
            t = threading.Thread(target=endRecordingEventHandler)
            t.start()
